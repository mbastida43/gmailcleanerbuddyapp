# 🛠️ Gmail Cleaner Buddy — guia técnico (Capacitor)

Como compilar, assinar e publicar o app Android.
Para a visão geral do produto, veja o [README](README.md).
...
| Lógica de análise/limpeza | `src/server.ts` | portada para `src/gmail.ts` (leitura integral: o cabeçalho From de TODAS as mensagens da caixa, uma a uma, sem amostra; limpeza via `batchModify`) |

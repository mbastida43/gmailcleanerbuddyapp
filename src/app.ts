...
const TRANSLATIONS: Record<Lang, Record<string, string>> = {
  pt: {
    ...
    'list.note': 'Contamos e-mails, um a um. A busca do Gmail agrupa e-mails do mesmo assunto em conversas, então o número dela costuma ser menor. É o número daqui que vai para a lixeira.',
    'btn.clean': 'Limpar',
  ...
  en: {
    ...
    'list.note': 'We count emails, one by one. Gmail search groups emails with the same subject into conversations, so its number is usually smaller. The number here is what goes to the trash.',
    'btn.clean': 'Clean',
  ...
  es: {
    ...
    'list.note': 'Contamos correos, uno a uno. La búsqueda de Gmail agrupa los correos del mismo asunto en conversaciones, por eso su número suele ser menor. El número de aquí es el que va a la papelera.',
    'btn.clean': 'Limpiar',
  ...
  fr: {
    ...
    'list.note': 'Nous comptons les e-mails un par un. La recherche Gmail regroupe les e-mails du même sujet en conversations, son nombre est donc souvent plus petit. C’est le nombre affiché ici qui part à la corbeille.',
    'btn.clean': 'Nettoyer',
  ...
  it: {
    ...
    'list.note': 'Contiamo le email una a una. La ricerca di Gmail raggruppa le email con lo stesso oggetto in conversazioni, quindi il suo numero è di solito più basso. È il numero qui che finisce nel cestino.',
    'btn.clean': 'Pulisci',
  ...
  ru: {
    ...
    'list.note': 'Мы считаем письма по одному. Поиск Gmail объединяет письма с одной темой в цепочки, поэтому его число обычно меньше. В корзину уходит именно число, показанное здесь.',
    'btn.clean': 'Очистить',
  ...
  zh: {
    ...
    'list.note': '我们逐封统计邮件。Gmail 搜索会把相同主题的邮件归为一个会话，因此它的数字通常更小。移入垃圾箱的是这里显示的数字。',
    'btn.clean': '清理',
